...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(__('Delete Contractor'), ['action' => 'delete', $contractor->id], ['confirm' => __('Are you sure you want to delete the contractor {0} {1}?', $contractor->first_name, $contractor->last_name), 'class' => 'side-nav-item']) ?>
